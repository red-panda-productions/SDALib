...
MACRO(INSTALL_SDA_PACKAGES TARGET_NAME)
	...
	IF(WIN32)
		...
		MESSAGE(STATUS BANANA "${MYSQL_BIN_DIR}/libcrypto-1_1.dll")
		MESSAGE(STATUS BANANA "${MYSQL_BASE_DIR}")

		add_custom_command(TARGET ${TARGET_NAME} POST_BUILD
				COMMAND ${CMAKE_COMMAND} -E copy "${MYSQL_BIN_DIR}/libcrypto-1_1.dll" $<TARGET_FILE_DIR:${TARGET_NAME}>
				COMMAND_EXPAND_LISTS
				)

		add_custom_command(TARGET ${TARGET_NAME} POST_BUILD
				COMMAND ${CMAKE_COMMAND} -E copy "${MYSQL_BIN_DIR}/libssl-1_1.dll" $<TARGET_FILE_DIR:${TARGET_NAME}>
				COMMAND_EXPAND_LISTS
				)
