...
MACRO(INSTALL_PYTHON_TEST_FILES TARGET_NAME)
	...
	#INSTALL_PYTHON_SIMULATION(SDALibTests)
...
MACRO(INSTALL_PYTHON_SIMULATION TARGET_NAME)
	add_custom_command(TARGET ${TARGET_NAME} POST_BUILD
			COMMAND ${CMAKE_COMMAND} -E copy "${CMAKE_SOURCE_DIR}/SDALib-Python/setup.py" $<TARGET_FILE_DIR:${TARGET_NAME}>
			COMMAND_EXPAND_LISTS
			)
	add_custom_command( TARGET ${TARGET_NAME} POST_BUILD
			COMMAND ${Python3_EXECUTABLE} ${CMAKE_SOURCE_DIR}/${TARGET_NAME}/setup.py install)
ENDMACRO(INSTALL_PYTHON_SIMULATION TARGET_NAME)