...
PyObject* PythonDriver::GetSDATypeObject(SDAData& p_data)
{
    PyObject* SDATypes;
...
/// @return         The python object
PyObject* PythonDriver::GetCarObject(tCarElt& p_car)
{
    PyObject* car;
...
/// @return           The python object
PyObject* PythonDriver::GetCarInitObject(tInitCar& p_initCar)
{
    PyObject* carInit;
...
/// @return           The python object
PyObject* PythonDriver::GetWheelSpecificationObject(tWheelSpec& p_wheelSpec)
{
    PyObject* wheelSpec;
...
/// @return           The python object
PyObject* PythonDriver::GetVisualAttributesObject(tVisualAttributes& p_visualAttributes)
{
    ...
    try
    {
        ...
        visualAttributesArgs[1] = GetVectorObject(p_visualAttributes.exhaustPos[0].x, p_visualAttributes.exhaustPos[0].y, p_visualAttributes.exhaustPos[0].z);
        visualAttributesArgs[2] = GetVectorObject(p_visualAttributes.exhaustPos[1].x, p_visualAttributes.exhaustPos[1].y, p_visualAttributes.exhaustPos[1].z);
...
/// @return           The python object
PyObject* PythonDriver::GetCarPublicObject(tPublicCar& p_publicCar)
{
    PyObject* publicCar;
...
/// @return           The python object
PyObject* PythonDriver::GetDynamicPointObject(tDynPt& p_dynPt)
{
...
/// @return           The python object
PyObject* PythonDriver::GetTrackLocationObject(tTrkLocPos& p_trackLoc)
{
...
/// @return           The python object
PyObject* PythonDriver::GetTrackSegmentObject(tTrackSeg& p_trackSeg)
{
    ...
    try
    {
        ...
        trackSegArgs[1] = PyLong_FromLong(static_cast<long>(p_trackSeg.id));
        trackSegArgs[2] = PyLong_FromLong(static_cast<long>(p_trackSeg.type));
        trackSegArgs[3] = PyLong_FromLong(static_cast<long>(p_trackSeg.type2));
        trackSegArgs[4] = PyLong_FromLong(static_cast<long>(p_trackSeg.style));
        trackSegArgs[5] = PyFloat_FromDouble(p_trackSeg.length);
        ...
        trackSegArgs[14] = GetVectorObject(p_trackSeg.center.x, p_trackSeg.center.y, p_trackSeg.center.z);

        trackSegArgs[15] = GetVectorObject(p_trackSeg.vertex[0].x, p_trackSeg.vertex[0].y, p_trackSeg.vertex[0].z);
        trackSegArgs[16] = GetVectorObject(p_trackSeg.vertex[1].x, p_trackSeg.vertex[1].y, p_trackSeg.vertex[1].z);
        trackSegArgs[17] = GetVectorObject(p_trackSeg.vertex[2].x, p_trackSeg.vertex[2].y, p_trackSeg.vertex[2].z);
        trackSegArgs[18] = GetVectorObject(p_trackSeg.vertex[3].x, p_trackSeg.vertex[3].y, p_trackSeg.vertex[3].z);
        ...
        trackSegArgs[31] = GetVectorObject(p_trackSeg.rgtSideNormal.x, p_trackSeg.rgtSideNormal.y, p_trackSeg.rgtSideNormal.z);
...
/// @return           The python object
PyObject* PythonDriver::GetCarRaceInfoObject(tCarRaceInfo& p_carRaceInfo)
{
...
/// @return           The python object
PyObject* PythonDriver::GetCarPrivObject(tPrivCar& p_privCar)
{
    PyObject* privCar;
...
/// @param  p_posD The posD data
/// @return           The python object
PyObject* PythonDriver::GetPosDObject(tPosd& p_posD)
{
    PyObject* posD;
...
PyObject* PythonDriver::GetCollisionStateObject(tCollisionState& p_collisionState)
{
    ...
    try
    {
        ...
        collisionStateArgs[1] = GetVectorObject(p_collisionState.pos[0], p_collisionState.pos[1], p_collisionState.pos[2]);
        collisionStateArgs[2] = GetVectorObject(p_collisionState.force[0], p_collisionState.force[1], p_collisionState.force[2]);
...
/// @return             The python object
PyObject* PythonDriver::GetVectorObject(double p_x, double p_y, double p_z)
{
    PyObject* vector;
...
/// @return             The python object
PyObject* PythonDriver::GetCarCtrlObject(tCarCtrl& p_carCtrl)
{
...
/// @return             The python object
PyObject* PythonDriver::GetCarSetupObject(tCarSetup& p_carSetup)
{
    PyObject* carSetup;
...
void PythonDriver::FillCarSetupArray(int p_start, int p_end, PyObject* p_carSetupArray[], tCarSetupItem* p_carSetupItems)
{
...
/// @return             The python object
PyObject* PythonDriver::GetCarSetupItemObject(tCarSetupItem& p_carSetupItem)
{
...
/// @return             The python object
PyObject* PythonDriver::GetCarPitCmdObject(tCarPitCmd& p_carPitCmd)
{
    PyObject* carPitCmd;
...
/// @return             The python object
PyObject* PythonDriver::GetSituationObject(tSituation& p_situation)
{
    PyObject* situation;
...
/// @return             The python object
PyObject* PythonDriver::GetRaceInfoObject(tRaceAdmInfo& p_raceInfo)
{
    PyObject* raceInfo;
...
PyObject* PythonDriver::GetObjectFromArgs(PyObject* p_classInit, PyObject* p_initArgs[], int p_length)
{
    PyObject* objectInit;
